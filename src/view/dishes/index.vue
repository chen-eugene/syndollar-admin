            ...
            <el-card class="dishes-card"
                ...
                <div class="dishes-aside">
                    ...
                    <div class="dishes-price">
                        ...
                        <span class="prime" v-if="item.soldPrice !== item.primePrice">{{ item.primePrice | currency }}</span>
                    </div>
                    ...
                    <div class="dishes-operate">
                        ...
                        <el-tooltip class="item" effect="dark" content="售罄" placement="top" v-if="!item.soldOut">
            ...
            <el-form :model="discountForm" class="discount-form" ref="discountForm">
                ...
                <el-form-item prop="soldPrice" label="售价">
                    <el-input v-model="discountForm.soldPrice">
                        <el-select v-model="discountForm.quikSale" slot="append" placeholder="快速打折" @change="quikSale">
