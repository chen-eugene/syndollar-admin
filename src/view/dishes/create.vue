            ...
            <el-row :gutter="40">
                <el-col :span="12">
                    ...
                    <el-form-item prop="description" label="描述">
                        <el-input type="textarea" :rows="4" v-model="form.description" placeholder="请输入" :maxlength="200" show-word-limit></el-input>
                    </el-form-item>
                </el-col>
...
export default {
    ...
    methods: {
        ...mapActions('dishes', ['createDishesX']),
        ...
        async submitDishes () {
            try {
                ...
                const response = await this.createDishesX(params)
                if (response.code === 200) {
                    this.$message({
                        type: 'success',
                        message: '添加成功'
